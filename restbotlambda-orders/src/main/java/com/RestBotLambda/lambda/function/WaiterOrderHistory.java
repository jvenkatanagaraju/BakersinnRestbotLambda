	...
	public class WaiterOrderHistory implements RequestHandler<OrdersHistoryRequest, AllOrderResponse> {
		...
		public AllOrderResponse handleRequest(OrdersHistoryRequest orderHistoryRequest, Context context) {
			try {
				...
				String waiterId = orderHistoryRequest.getwaiterId();
				Item OrderItem=orderTable.getItem("waiterId",waiterId);
				String restId=OrderItem.getString("id");
				...
				List<MenuCategoryResponse> menuItemResponse = restBotLambdaserviceImpl.getMenuCategories(OrderItem.getString("id"));
		...
		public static void main(String[] args) {
			...
			OrdersHistoryRequest orderHistoryRequest = new OrdersHistoryRequest();
			orderHistoryRequest.setWaiterId("23_1");
			orderHistoryRequest.setDate("03/04/2017");
			FbLoginServiveImpl.handleRequest(orderHistoryRequest, context);
		}
