...
public class GetOrders implements RequestHandler<String, AllOrderResponse> {

	public AllOrderResponse handleRequest(String botName, Context context) {
		...
		allOrderResponse.setBotName(botName);
	...
	/*public static void main(String[] args) {
		GetOrders FbLoginServiveImpl = new GetOrders();
		Context context = null;
		String orderItem = "moxieitwebsite";
