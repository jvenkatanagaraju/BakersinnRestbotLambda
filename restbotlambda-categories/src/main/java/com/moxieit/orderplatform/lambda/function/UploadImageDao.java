...
public class UploadImageDao
	...
	private static String BUCKET_NAME = "restaurant-all-images";
	...
	public Map<String, Object> handleRequest(Map<String, Object> input, Context context) {
		...
		byte[] fileBytes = decodeImage((String) input.get("file"));
		...
		//objectMetadata.setContentType("Applicaction/zip");
	...
	private String getDateTimeForFileName(Context context) {
		...
		Date today = new Date();
		String dateString = formatter.format(today) + ".png";
		// logs the date
